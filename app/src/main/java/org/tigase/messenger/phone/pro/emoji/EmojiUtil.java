package org.tigase.messenger.phone.pro.emoji;
...
public class EmojiUtil {
    ...
    public static void handlerEmojiText(EditText comment, String content, Context context) throws IOException {
        Log.e("tanghongling","content------"+content);
    ...
    public static SpannableStringBuilder handlerEmojiText2( String content, Context context){
        Log.e("tanghongling","content---4---"+content);
        SpannableStringBuilder sb = new SpannableStringBuilder(content);
        String regex = "\\[(\\S+?)\\]";
        Pattern p = Pattern.compile(regex);
        Matcher m = p.matcher(content);
